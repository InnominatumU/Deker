{{-- resources/views/gestao/documentosedit.blade.php --}}
<x-app-layout>
  <x-slot name="header">
    <h1 class="font-bold text-xl">GESTÃO • DOCUMENTOS — EDITAR</h1>
  </x-slot>
  ...
  <div class="max-w-4xl mx-auto p-6 space-y-6">
    ...
    <form method="POST" action="{{ route('gestao.documentos.update', $id) }}" class="space-y-6">
      @csrf
      @method('PUT')
      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
          ...
          <button type="submit" class="px-4 py-2 rounded bg-green-600 text-white hover:bg-green-700">ATUALIZAR E AVANÇAR</button>
        </div>
      </div>
    </form>
  </div>
